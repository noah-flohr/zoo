...
class TernaryDenseNet(tf.keras.models.Model):
    pass
...
class TernaryDenseNetFactory(ModelFactory):

    @property
    def input_quantizer(self):
        return lq.quantizers.SteTern(ternary_weight_networks=True)
    ...
    def kernel_constraint(self):
        return lq.constraints.WeightClip(clip_value=1)
    ...
    def build(self) -> TernaryDenseNet:
        ...
        model = TernaryDenseNet(inputs=self.image_input, outputs=x, name=self.name)
...
@factory
class TernaryDenseNet28Factory(TernaryDenseNetFactory):
    name = "ternary_densenet28"
    ...
    def imagenet_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_28_weights.h5",
    ...
    def imagenet_no_top_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_28_weights_notop.h5",
            file_hash="a376df1e41772c4427edd1856072b934a89bf293bf911438bf6f751a9b2a28f5",
        )


@factory
class TernaryDenseNet37Factory(TernaryDenseNetFactory):
    name = "ternary_densenet37"
    reduction = (3.3, 3.3, 4)
    dilation_rate = (1, 1, 1, 1)
    layers = (6, 8, 12, 6)
    ...
    def imagenet_no_top_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_37_weights_notop.h5",
            file_hash="4e12bca9fd27580a5b833241c4eb35d6cc332878c406048e6ca8dbbc78d59175",
        )


@factory
class TernaryDenseNet37DilatedFactory(TernaryDenseNetFactory):
    name = "ternary_densenet37_dilated"
    reduction = (3.3, 3.3, 4)
    ...
    def imagenet_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_37_dilated_weights.h5",
    ...
    def imagenet_no_top_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.1",
            file="ternary_densenet_37_dilated_weights_notop.h5",
            file_hash="8b31fbfdc8de08a46c6adcda1ced48ace0a2ff0ce45a05c72b2acc27901dd88b",
        )


@factory
class TernaryDenseNet45Factory(TernaryDenseNet28Factory):
    name = "ternary_densenet45"
    reduction = (2.7, 3.3, 4)
    dilation_rate = (1, 1, 1, 1)
    layers = (6, 12, 14, 8)
    ...
    def imagenet_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_45_weights.h5",
    ...
    def imagenet_no_top_weights_path(self):
        return utils.download_pretrained_model(
            model="ternary_densenet",
            version="v0.1.0",
            file="ternary_densenet_45_weights_notop.h5",
...
def TernaryDenseNet28(
    *,  # Keyword arguments only
    ...
    """Instantiates the TernaryDenseNet 28 architecture.

    Can't load weights pre-trained on ImageNet!

    ```netron
    ternary_densenet-v0.1.0/ternary_densenet_28.json
    ```
    ```summary
    literature.TernaryDenseNet28
    ```
    ```plot-altair
    ...
    """
    return TernaryDenseNet28Factory(
...
def TernaryDenseNet37(
    *,  # Keyword arguments only
    ...
    """Instantiates the TernaryDenseNet 37 architecture.

    Can't load weights pre-trained on ImageNet.

    ```netron
    ternary_densenet-v0.1.0/ternary_densenet_37.json
    ```
    ```summary
    literature.TernaryDenseNet37
    ```
    ```plot-altair
    ...
    # Raises
        ValueError: in case of invalid argument for `weights`, or invalid input shape.
    """
    return TernaryDenseNet37Factory(
        input_shape=input_shape,
        input_tensor=input_tensor,
        weights=weights,
        include_top=include_top,
...
def TernaryDenseNet37Dilated(
    *,  # Keyword arguments only
    ...
    """Instantiates the TernaryDenseNet 37Dilated architecture.

    Can't load weights pre-trained on ImageNet.

    ```netron
    ternary_densenet-v0.1.0/ternary_densenet_37_dilated.json
    ```
    ```summary
    literature.TernaryDenseNet37Dilated
    ```
    ```plot-altair
    ...
    # Raises
        ValueError: in case of invalid argument for `weights`, or invalid input shape.
    """
    return TernaryDenseNet37DilatedFactory(
        input_shape=input_shape,
        input_tensor=input_tensor,
        weights=weights,
        include_top=include_top,
...
def TernaryDenseNet45(
    *,  # Keyword arguments only
    ...
    """Instantiates the TernaryDenseNet 45 architecture.

    Can't load weights pre-trained on ImageNet.

    ```netron
    ternary_densenet-v0.1.0/ternary_densenet_45.json
    ```
    ```summary
    literature.TernaryDenseNet45
    ```
    ```plot-altair
    ...
    # Raises
        ValueError: in case of invalid argument for `weights`, or invalid input shape.
    """
    return TernaryDenseNet45Factory(
        input_shape=input_shape,
        input_tensor=input_tensor,
        weights=weights,
        include_top=include_top,
